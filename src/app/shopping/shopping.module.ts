...
import { ManageMyOrdersComponent } from './components/manage-my-orders/manage-my-orders.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'my/order/:id', component: ManageMyOrdersComponent, canActivate: [AuthGuard] },
