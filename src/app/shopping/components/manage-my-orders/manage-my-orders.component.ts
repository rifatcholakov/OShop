...
@Component({
  selector: 'app-manage-my-orders',
  templateUrl: './manage-my-orders.component.html',
  styleUrls: ['./manage-my-orders.component.css']
})
export class ManageMyOrdersComponent implements OnInit {
